...
?>
        ...
        <div class="container">
            ...
            <div class="page-header">
                <h1>오늘 뭐 먹지? <small>Modify</small></h1>
            </div>
            ...
            <div class="header">
                <h2>오늘 뭐 먹지? 회원정보수정</h2>
            </div>

            <form action="php/modify.php" method="POST" name="register" onsubmit="return check()">

                <?php include('errors.php'); ?>
                <div class="input-group">
                    <label>자기소개</label>
                    <p><textarea name="myself" rows="4" cols="125" placeholder="자기소개"></textarea></p>
                </div>
                <div class="input-group">
                    <label>비밀번호</label>
                ...
                <div class="input-group">
                    <label>비밀번호 확인</label>
                    <input type="password" name="password_chk" id="password_chk" onkeyup="pw_Check()">
